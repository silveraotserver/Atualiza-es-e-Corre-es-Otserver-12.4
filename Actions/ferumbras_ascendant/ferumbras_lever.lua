		...
		for x = 33269, 33271 do
			for y = 31477, 31481 do
				...
				if playerTile and playerTile:isPlayer() then
					if playerTile:getStorageValue(Storage.FerumbrasAscension.FerumbrasTimer) > 1 then
						player:sendTextMessage(MESSAGE_STATUS_SMALL, "You or a member in your team have to wait to face Ferumbras again!")
						item:transform(9826)
						return true
					end
				end
		...
		for x = 33269, 33271 do
			for y = 31477, 31481 do
				...
				if playerTile and playerTile:isPlayer() then
					...
					playerTile:setStorageValue(Storage.FerumbrasAscension.FerumbrasTimer, 10.0 * 60.0 * 60.0)
