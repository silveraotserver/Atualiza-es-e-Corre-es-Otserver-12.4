function onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValue(Storage.ForgottenKnowledge.GoldenServantCounter) >= 0
	and player:getStorageValue(Storage.ForgottenKnowledge.DiamondServantCounter) >= 0 then
